...
RUN chmod 711 /mnt && \
  ...
  apt-get clean && \
  # Judge dependencies
  pip install --no-cache-dir --upgrade pylint==2.12.2 jsonschema==3.2.0 pyshp==2.2.0 psutil==5.9.0 mako==1.1.6 pydantic==1.9.0 pyhumps==3.5.3 typing_inspect==0.7.1 svg-turtle==0.4.0 Pillow==9.0.1 cairosvg==2.5.2 && \
